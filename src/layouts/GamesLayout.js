    ...
    <>
      ...
      <div className="h-[80px] relative rounded-md text-gray-400 bg-[radial-gradient(at_right_top,_#566573,_#475664,_#2d3d4a)]">
        ...
        <div className="absolute -bottom-5 right-5 w-[206px] h-[40px] bg-black">
          <div className="text-gray-300 font-thin pl-2 pt-2">฿1,590.00</div>
          <button
      ...
      <div className="text-gray-300 ">
        ...
        <div className="mx-auto mt-5 mb-5 flex justify-center ">
        ...
        Unwritten.
        <div className="mx-auto mt-5 mb-5 flex justify-center ">
          <img src="https://cdn.akamai.steamstatic.com/steam/apps/990080/extras/HWL_Pub_Dev_Logo.png?t=1676412613"/>
        </div>
      </div>
      {/* end ABOUT THIS GAME */}
